...
import { Expense, updateExpense } from "@/lib/serverCall/groupDetailsPageCalls"
        ...
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center">
            <div className="bg-white rounded p-6 w-full max-w-md space-y-4">
                ...
                <div className="flex justify-end gap-2">
                    {isEditing ? (
                        <>
                            <button onClick={handleSave} className="border px-4 py-2 bg-black text-white rounded" disabled={loading}>
                                {!loading ? 'Save' : 'Saving...'}
                            </button>
                        ...
                        <>
                            <button onClick={enterEditMode} className="border px-4 py-2 bg-black text-white rounded">
                                Edit
                            </button>
